...
| `idea_000022` | Evidence provenance under recursive AI web contamination | 91/100 | `execution_ready` | `execution_ready` | Write a one-page definition note separating AI-generated content, incorrect content, unverifiable recursive synthesis, circular citation, and retrieval contamination. | `ideas/structured/idea_000022_evidence_provenance_under_recursive_ai_web_contamination.yaml` |
...
| `idea_000021` | YOLO-to-foundation-vision reliable deployment decision system | 89/100 | `execution_ready` | `execution_ready` | Create a one-page failure taxonomy table for YOLO experiments: data, label, model, evaluation, deployment, and decision-policy failures. | `ideas/structured/idea_000021_yolo_to_foundation_vision_reliable_deployment_decision_system.yaml` |
...
| `idea_000023` | Search trust collapse under AI-generated web pollution | 84/100 | `execution_ready` | `execution_ready` | Write a one-page definition separating retrieval collapse, search trust collapse, source diversity decay, human-source scarcity, and evidence provenance depth. | `ideas/structured/idea_000023_search_trust_collapse_under_ai_generated_web_pollution.yaml` |
...
- idea_000021 - YOLO-to-foundation-vision reliable deployment decision system - 89/100 - execution_ready
- idea_000022 - Evidence provenance under recursive AI web contamination - 91/100 - execution_ready
- idea_000023 - Search trust collapse under AI-generated web pollution - 84/100 - execution_ready
