...
| Core | `idea_os/` | YAML I/O, store, scoring, similarity, graphing, clustering, research, planning sync |
...
6. `weekly_review.py` selects top ideas for near-term attention.
7. Planning scripts write only bridge notes.
